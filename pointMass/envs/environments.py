...
class pointMassEnv(gym.Env):
		...
		def calc_state(self):
			...
			return np.array([x,y,velocity,self.goal_x,self.goal_y])
...
# 	#env._p.stepSimulation()
# 	time.sleep(0.005)
# 	action = [test_env._p.readUserDebugParameter(test_env.x_shift), test_env._p.readUserDebugParameter(test_env.y_shift)]
